...
class GamesTableViewController: UITableViewController {
    ...
    private var labelEmptyGames = UILabel()
    ...
    override func viewDidLoad() {
        ...
        labelEmptyGames.text = "Você não tem jogos cadastrados"
        labelEmptyGames.textAlignment = .center
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        tableView.backgroundView = count == 0 ? labelEmptyGames : nil
